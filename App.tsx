            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <div className="mt-12 text-center">
                    <button
                        ...
                        ${canGenerate ? 'bg-blue-600 hover:bg-blue-700 text-white shadow-lg' : 'bg-gray-700 text-gray-500 cursor-not-allowed'}`}
                    >
                        {isLoading ? (
                           <>
                 ...
                 {isLoading && totalFileCount > 0 && (
                    <div className="w-full max-w-xl mx-auto bg-gray-700 rounded-full h-2.5 mt-4">
                        <div className="bg-blue-600 h-2.5 rounded-full" style={{ width: `${(processedFileCount / totalFileCount) * 100}%` }}></div>
                    </div>
                )}

                {downloadUrl && !isLoading && (
                    <div className="mt-10 text-center p-8 bg-gray-800/50 border border-green-500/30 rounded-lg max-w-md mx-auto">
                        <h3 className="text-2xl font-bold text-green-400 mb-4">Success!</h3>
                        <p className="text-gray-400 mb-6">Your screenshot package is ready for download.</p>
                        <a
                            href={downloadUrl}
